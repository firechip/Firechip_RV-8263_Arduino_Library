...
// Register names:
#define RV8263_RAM 0x07
#define RV8263_HUNDREDTHS 0x10
#define RV8263_SECONDS 0x11
#define RV8263_MINUTES 0x12
#define RV8263_HOURS 0x13
#define RV8263_WEEKDAYS 0x14
#define RV8263_DATE 0x15
#define RV8263_MONTHS 0x16
#define RV8263_YEARS 0x17
#define RV8263_MINUTES_ALARM 0x18
#define RV8263_HOURS_ALARM 0x19
#define RV8263_WEEKDAYS_DATE_ALARM 0x1A
#define RV8263_TIMER_0 0x1B
#define RV8263_TIMER_1 0x1C
#define RV8263_EXTENSION 0x1D
#define RV8263_FLAG 0x1E
#define RV8263_CONTROL 0x1F
#define RV8263_HUNDREDTHS_CAPTURE 0x20
#define RV8263_SECONDS_CAPTURE 0x21
#define RV8263_OFFSET 0x2C
#define RV8263_EVENT_CONTROL 0x2F
...
#define RV8263_ENABLE true
#define RV8263_DISABLE false
...
public:
  ...
  bool setEpoch(uint32_t value, bool use1970sEpoch = false, int8_t timeZoneQuarterHours = 0); // If timeZoneQuarterHours is non-zero, update RV8263_RAM. Add the zone to the epoch before setting
  ...
  void setTimeZoneQuarterHours(int8_t quarterHours); // Write the time zone to RV8263_RAM as int8_t (signed) in 15 minute increments
  int8_t getTimeZoneQuarterHours(void);              // Read RV8263_RAM (int8_t (signed))
